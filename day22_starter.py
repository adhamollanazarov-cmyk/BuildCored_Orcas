...
def generate_test_circuit(output_path="test_circuit.png"):
    ...
    draw.line([(cx, cy), (cx, cy + 60)], fill="black", width=lw)
...
COMPONENT_PROMPT = (
    ...
    "op-amps, voltage sources, ground symbols, input labels, and output labels. "
    "If a component has a label or value, include it. "
    "If you see none, say 'No components identified'. "
    "Maximum 8 items. Format:\n"
    "1. component name - label/value if visible"
)
...
WIRING_ERROR_PROMPT = (
    ...
    "Identify any obvious wiring errors or unusual connections. "
    "Check for missing ground, floating inputs, short circuits, disconnected wires, "
    "incorrect polarity, or components connected in impossible ways. "
    "List up to 3 specific issues. "
    "If the schematic looks correct, say: 'No obvious errors detected'. "
    "Be concise."
)
...
def main():
    ...
    if not has_webcam:
        print("⚠️  No webcam found. Using keyboard mode.")
    ...
    while True:
        ...
        if key == ord("q"):
            ...
            for fname in ["circuit.jpg", "circuit.png", "circuit.jpeg", "schematic.jpg"]:
                ...
                print("   Place a circuit photo named 'circuit.jpg' or 'circuit.png' here.")
